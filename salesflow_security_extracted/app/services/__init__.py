...
class ServiceFactory:
    ...
    def __init__(self):
        ...
        self._autopilot_service: Optional[AutopilotService] = None
    ...
    @property
    def autopilot_service(self) -> AutopilotService:
        """Get or create AutopilotService instance."""
...
def get_autopilot_service() -> AutopilotService:
    """Dependency for AutopilotService."""
    return service_factory.autopilot_service
