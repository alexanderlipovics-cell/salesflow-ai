...
class Settings(BaseSettings):
    ...
    # CORS
    cors_origins: str = "https://salesflow-system.com,https://www.salesflow-system.com,https://salesflow.ai,https://www.salesflow.ai,https://alsales.ai,https://www.alsales.ai,http://localhost:3000,http://localhost:5173"
