-- ============================================================================
-- LIVE ASSIST MODE - CLEAN INSTALL
-- Bereinigt existierende Views und erstellt Tabellen
-- ============================================================================
...
CREATE TABLE IF NOT EXISTS quick_facts (
    ...
    evidence_id UUID,                 -- Optional: REFERENCES evidence_items(id)
...
-- Falls schon existiert, nur aktualisieren
-- ===================

DO $$ 
BEGIN
    -- Check if table exists
    IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'objection_responses' AND table_type = 'BASE TABLE') THEN
