...
Always uses cheapest model (GPT-4o-mini) for fast classification.
"""
...
Category:"""
    ...
    INTENT_TO_MODEL = {
        ...
        "CONTENT": ModelTier.STANDARD, # Content generation needs quality
    ...
    async def detect_intent(self, message: str) -> str:
        """
        Detect user intent using GPT-4o-mini for cost optimization.
